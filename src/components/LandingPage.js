...
const LandingPage = () => {
  useEffect(() => {
    ...
    tl.to('.smart-contract-image', { duration: 1, opacity: 1, ease: "power2.out" }, 0);
  }, []);
  ...
  return (
    ...
    >
      <img src="smartcontracts.png" alt="Smart Contracts" className="smart-contract-image" style={{ width: '500px', height: '500px', marginBottom: '20px', zIndex: 5, opacity: 0 }} />
